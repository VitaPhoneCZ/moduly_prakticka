...
-- --------------------------------------------------------
INSERT INTO `zaznamy` (`jmeno`, `email`, `predmet`, `hodnoceni`, `kategorie`, `popis`, `datum_pridani`) VALUES
('Jan Novák',  'jan@email.cz',   'Matematika', 5, 'A', 'Skvělý předmět, doporučuji!',       '2026-04-10 09:15:00'),
('Eva Malá',   'eva@email.cz',   'Fyzika',     3, 'B', 'Docela těžké, ale zvládnutelné.',     '2026-04-18 14:30:00'),
('Tomáš Vlk',  'tomas@email.cz', 'Čeština',    4, 'A', 'Zajímavé texty, dobrý učitel.',      '2026-04-28 17:55:00');
